 ...
 */
const CDN =
  "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_292,h_300/c_fill/";
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRl9d4mCkegQn_dnQFq6hiPNFcQowRaBtzacA&s"
          alt=""
        />
      </div>
...
const Footer = () => {
  return <div className="footer">Design by Sneha</div>;
};
const AppLayout = () => {
  return (
    <div className="app">
