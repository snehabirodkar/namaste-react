...
Ans: `Emmet` is the essential toolkit for web-developers. It allows you to **type shortcuts** that are then expanded into full pieces of code for writing HTML and CSS, based on an abbreviation structure most developers already use that expands into full-fledged HTML markup and CSS rules.
...
Ans: `React` is named React because of its ability to react to changes in data.
